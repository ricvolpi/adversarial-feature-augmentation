...
class Model(object):
    ...
    def feature_extractor(self, images, reuse=False, return_output = False, from_features=False):
	...
	# Just to calculate accuracy of generated features
	if from_features:
	    with tf.variable_scope('feature_extractor', reuse=reuse):
		net = slim.fully_connected(images, 10, activation_fn=None, scope='fc5')
		return net
    ...
    def build_model(self):
	    ...
	    #inferred labels
	    self.inferred_labels = self.feature_extractor(self.gen_features, reuse=tf.AUTO_REUSE, from_features=True)
